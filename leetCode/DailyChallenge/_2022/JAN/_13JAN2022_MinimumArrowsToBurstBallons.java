...
/**
 * @docs https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/
 *
 ...
 */
public class _13JAN2022_MinimumArrowsToBurstBallons {
    public int findMinArrowShots(int[][] ballons) {

        if(ballons==null || ballons.length==0) return 0;

        Arrays.sort(ballons, Comparator.comparingInt(a -> a[1]));
